        ...
        renderHTML() {
            ...
            capaCategories.forEach(cat => {
                ...
                let ByCategoryLabelData: ByCategoryLabelData = {
                    ...
                    statusWiseInitialData: JSON.parse(JSON.stringify(statusWiseData)),
                    statusWiseData: JSON.parse(JSON.stringify(statusWiseData)),
...
// .chart { width: 90%; min-height: 350px; cursor:pointer; }

// .bigChart{ width: 90%; min-height: 900px; cursor:pointer; }

// .closureTimeChart{ width: 90%; min-height: 315px; cursor:pointer; }

// .dateFilter{ display:flex; margin-left: 45px; }

// .tableDateFilter{ display:flex; margin-left: 350px; }

// .filterDates { width: 115px; margin: 0 6px; }

// .date-filter-form-control { height: 20px; padding: 6px 12px; font-size: 14px; line-height: 1.42857143; color: #555; background-color: #fff; background-image: none; border: 1px solid #ccc; border-radius: 4px; }

// .date-filter-btn { margin-bottom: 0; margin-left: 12px; font-weight: 400; text-align: center; white-space: nowrap; vertical-align: middle; touch-action: manipulation; cursor: pointer; background-image: none; border: 1px solid transparent; padding: 0px 5px; font-size: 12px; line-height: 1.42857143; border-radius: 4px; }
